...
class generate_heuristic_placement_algo_instance:
  def __init__(self, 
    ...
    self.edg_file_name = edge_file_name
    ...
    self.gen_tn = gen_tn
    #load the nodes
    pkl_data = pkl.load( open(self.node_file_name, "rb" ) )
    self.node_x = pkl_data["node_x"]
    self.node_y = pkl_data["node_y"]
    ...
    self.adj = None
    #---------------------------
    #load the edges and create the adj
